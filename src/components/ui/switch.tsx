...
export function Switch({ checked, defaultChecked, onCheckedChange, disabled, className }: SwitchProps) {
  return (
    ...
    >
      <span className="pointer-events-none block h-4 w-4 rounded-full bg-zinc-950 shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0" />
    </SwitchPrimitive>
  );
}
